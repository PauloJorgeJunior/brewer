...
public class TabelaItensVendaTest {
	...
	public void deveManterTamanhoDaListaParaMesmasCervejas() throws Exception {
		...
		assertEquals(new BigDecimal("17.80"), tabelaItensVenda.getValorTotal());
	}

	@Test
	public void deveAlterarAQuantidadeDoItem() throws Exception {
		Cerveja c1 = new Cerveja();
		c1.setCodigo(1L);
		c1.setValor(new BigDecimal("3.00"));
